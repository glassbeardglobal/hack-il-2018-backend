...
def run(query, save_directory, num_images=100):
    ...
    # instead of download, return url
    return get_image_url(images, save_directory, num_images)
...
def main():
    ...
    print(run(args.search, args.directory, args.num_images))
